    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.description}>
                ¿Qué días quieres realizar esta actividad?
            </Text>
            ...
            <View style={styles.quickSelectContainer}>
                <TouchableOpacity onPress={() => setDays([0, 1, 2, 3, 4, 5, 6])} style={styles.quickSelectButton} activeOpacity={0.8}>
                    <Text style={styles.quickSelectText}>Todos los días</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setDays([1, 2, 3, 4, 5])} style={styles.quickSelectButton} activeOpacity={0.8}>
                    <Text style={styles.quickSelectText}>Días hábiles</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setDays([0, 2, 4, 6])} style={styles.quickSelectButton} activeOpacity={0.8}>
                    <Text style={styles.quickSelectText}>Días alternos</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.quickSelectContainer}>
                <TouchableOpacity onPress={() => setDays([])} style={styles.quickSelectButton} activeOpacity={0.8}>
