...
export default function CheckProofModal({
  isOpen,
  onClose,
  pact,
  streak,
  ...
  const renderContent = () => {
    ...
    if (
      habitType === "Actividad física" ||
      habitType === "Tiempo en pantalla"
    ) {
      return (
        <ImageProof
  ...
  const handleAccept = async () => {
    ...
    try {
      await updateUserStateStreak(
        streak.id_streak,
        userToUpdate,
        STREAK_USER_STATE.VALIDATED,
      );
  ...
  const handleReject = async () => {
    ...
    try {
      await updateUserStateStreak(
        streak.id_streak,
        userToUpdate,
        STREAK_USER_STATE.NOT_SUBMITTED,
      );
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          <ProofModalHeader habitType={habitType} onClose={handleClose} />
          ...
          <View style={styles.warningContainer}>
            ...
            <Text style={styles.warningText}>
              Revisa la evidencia de tu compañero para validar su progreso. Si
              la rechazas, se le solicitará subir una nueva prueba
            </Text>
          </View>
